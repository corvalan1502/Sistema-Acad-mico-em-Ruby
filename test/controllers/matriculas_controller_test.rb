...
class MatriculasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create matricula" do
    assert_difference("Matricula.count") do
      post matriculas_url, params: { matricula: { aluno_id: @matricula.aluno_id, disciplina_id: @matricula.disciplina_id, nota: @matricula.nota, semestre: @matricula.semestre } }
    end
  ...
  test "should update matricula" do
    patch matricula_url(@matricula), params: { matricula: { aluno_id: @matricula.aluno_id, disciplina_id: @matricula.disciplina_id, nota: @matricula.nota, semestre: @matricula.semestre } }
